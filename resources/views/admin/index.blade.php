...
@section('content')
	<div class="top_box">
		<div class="top_left">
			...
			<ul>
				<li><a href="{{ url('/') }}" target="_blank" class="active">前台预览</a></li>
	...
	<div class="menu_box">
		<ul>
            <li>
            	<h3><i class="fa fa-fw fa-clipboard"></i>Product</h3>
                <ul class="sub_menu">
					...
					<li><a href="{{ url('admin/article/create') }}" target="main"><i class="fa fa-fw fa-plus-square"></i>添加产品</a></li>
                    <li><a href="{{ url('admin/article') }}" target="main"><i class="fa fa-fw fa-list-ul"></i>产品明细</a></li>
...
<!--                     <li><a href="#" target="main"><i class="fa fa-fw fa-database"></i>备份还原</a></li>
 -->                </ul>
	...
	<div class="bottom_box">
		CopyRight © 2017. Powered By <a href="http://www.generalscan.com">http://www.generalscan.com</a>.
	</div>
	<!--底部 结束-->
@stop